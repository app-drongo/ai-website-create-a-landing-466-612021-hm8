...
import { ArrowRight, Fish, Users, Clock, Award } from "lucide-react"

export default function Cta() {
  const stats = [
    { value: "15K+", label: "Happy Diners", icon: Users },
    { value: "Fresh", label: "Daily Catch", icon: Fish },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full text-sm font-medium text-primary mb-8">
                <Fish className="size-4 mr-2" />
                Fresh Daily Specials Available
              </div>

              {/* Main Heading */}
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                Experience the Ocean's
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Indulge in sustainably sourced, premium seafood prepared by our master chefs. 
                Reserve your table today and taste the difference that fresh, ocean-to-table dining makes.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Featured in top culinary publications
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Book online or call us - same day tables available
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Responsibly caught seafood from trusted local fishermen
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Recognized for excellence in fine seafood dining
              </p>
            </div>
          </div>
        </div>
